...
void CCheckBox::Draw(bool hover)
{
	...
	if (Checked)
	{
		if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 0)
		{
			...
			Render::GradientV(a.x, a.y, 10, 10, Color(255, 255, 255, 200), Color(255, 255, 255, 200));
		}
...
void CSlider::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y + 1, m_iWidth, 7, Color(0, 0, 0, 255), Color(0, 0, 0, 245));
	...
	if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 0)
	{
		...
		Render::GradientV(a.x, a.y + 1, Location, 7, Color(255, 255, 255, 200), Color(255, 255, 255, 200));
	}
	else if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 1)
	{
		red = 186;
